...
{
    public class AdvancedLoginController : MonoBehaviour
    {
        [Header("SO")] 
        ...
        public void Login()
        {
            ...
            loginRoutine =  StartCoroutine(StudentLogin());
        }

        private IEnumerator StudentLogin()
        {
            ...
            using (UnityWebRequest www = UnityWebRequest.Post(ApiPaths.STUDENT_LOGIN(apiCommsController.UseCloudPath), "POST"))
            {
